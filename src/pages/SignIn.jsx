            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              >
                <label className="flex items-center">
                  <input
                    type="checkbox"
                    className="w-4 h-4 rounded border-white/20 bg-transparent text-primary-600 focus:ring-primary-600"
                  />
                  <span className="ml-2 text-white/70 text-sm">Remember me</span>
                </label>
                <Link
                  to="/forgot-password"
                  className="text-sm text-accent-orange hover:text-orange-400 transition-colors"
                >
                  Forgot password?
                </Link>
              </motion.div>
